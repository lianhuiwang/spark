...
//    }
  ...
  final class LongPairArraySorter extends SortDataFormat[PairLong, Array[Long]] {
    override def getKey(data: Array[Long], pos: Int) = ???

    override def newKey(): PairLong = new PairLong(0L, 0L)

    /** Return the sort key for the element at the given index. */
    override def getKey(data: Array[Long], pos: Int, reuse: PairLong): PairLong = {
      reuse._1 = data(2 * pos)
    ...
    /** Swap two elements. */
    override def swap(data: Array[Long], pos0: Int, pos1: Int) {
      var tmp = data(2 * pos0)
    ...
    override def copyElement(src: Array[Long], srcPos: Int,
     ...
     */
    override def copyRange(src: Array[Long], srcPos: Int,
     ...
     */
    override def allocate(length: Int): Array[Long] = new Array[Long](2 * length)
  }
